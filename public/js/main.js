...
if (
  (
    $(document).ready(function() {
      $(".premium").click(function(e) {
        ...
        $(".signin-container").removeClass("active"), setTimeout(function() {
          $(
            "\n        .landing, \n        .plane, \n        nav, \n        footer, \n        .right-side img, \n        .right-side svg, \n        .left-side,\n        .backarrow\n      "
          ).removeClass("active");
        }, 600);
  ...
  var createSVGEl = function(e) {
    var c = document.createElementNS("http://www.w3.org/2000/svg", "svg");
    return e
      ? (
          c.setAttributeNS(null, "viewBox", e.viewBox),
          c.setAttributeNS(null, "preserveAspectRatio", e.preserveAspectRatio)
        )
      : c.setAttributeNS(null, "viewBox", "0 0 100 100"), c.setAttribute(
      "xmlns",
      "http://www.w3.org/2000/svg"
    ), c;
  },
    controlCheckbox = function(e, c, t) {
      var o = createSVGEl(t);
      e.parentNode.appendChild(o), e.addEventListener("change", function() {
        e.checked ? draw(e, c) : reset(e);
      });
    },
    controlRadiobox = function(e, c) {
      var t = createSVGEl();
      e.parentNode.appendChild(t), e.addEventListener("change", function() {
        resetRadio(e), draw(e, c);
      });
    },
    draw = function(e, c) {
      var t,
        o,
        r = [],
        a = e.parentNode.querySelector("svg");
      switch (c) {
        case "cross":
          (t = pathDefs.cross), (o = animDefs.cross);
          break;
        case "fill":
          (t = pathDefs.fill), (o = animDefs.fill);
          break;
        case "checkmark":
          (t = pathDefs.checkmark), (o = animDefs.checkmark);
          break;
        case "circle":
          (t = pathDefs.circle), (o = animDefs.circle);
          break;
        case "boxfill":
          (t = pathDefs.boxfill), (o = animDefs.boxfill);
          break;
        case "swirl":
          (t = pathDefs.swirl), (o = animDefs.swirl);
          break;
        case "diagonal":
          (t = pathDefs.diagonal), (o = animDefs.diagonal);
          break;
        case "list":
          (t = pathDefs.list), (o = animDefs.list);
      }
      r.push(
        document.createElementNS("http://www.w3.org/2000/svg", "path")
      ), ("cross" !== c && "list" !== c) ||
        r.push(document.createElementNS("http://www.w3.org/2000/svg", "path"));
      for (var i = 0, n = r.length; i < n; ++i) {
        var s = r[i];
        a.appendChild(s), s.setAttributeNS(null, "d", t[i]);
        var l = s.getTotalLength();
        (s.style.strokeDasharray =
          l + " " + l), (s.style.strokeDashoffset = 0 === i
          ? Math.floor(l) - 1
          : l), s.getBoundingClientRect(), (s.style.transition = s.style.WebkitTransition = s.style.MozTransition =
          "stroke-dashoffset " +
          o.speed +
          "s " +
          o.easing +
    ...
    resetRadio = function(e) {
      Array.prototype.slice
        .call(
          document.querySelectorAll(
            'input[type="radio"][name="' + e.getAttribute("name") + '"]'
          )
        )
        .forEach(function(e) {
          var c = e.parentNode.querySelector("svg > path");
          c && c.parentNode.removeChild(c);
        });
    },
    checkbxsCross = Array.prototype.slice.call(
  ...
  checkbxsCross.forEach(function(e, c) {
    controlCheckbox(e, "cross");
  }), radiobxsFill.forEach(function(e, c) {
    controlRadiobox(e, "fill");
  }), checkbxsCheckmark.forEach(function(e, c) {
    controlCheckbox(e, "checkmark");
  }), radiobxsCircle.forEach(function(e, c) {
    controlRadiobox(e, "circle");
  }), checkbxsBoxfill.forEach(function(e, c) {
    controlCheckbox(e, "boxfill");
  }), radiobxsSwirl.forEach(function(e, c) {
    controlRadiobox(e, "swirl");
  }), checkbxsDiagonal.forEach(function(e, c) {
